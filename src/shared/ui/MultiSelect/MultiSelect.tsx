...
const MultiSelect = React.forwardRef<HTMLButtonElement, MultiSelectProps>(
  (
    ...
    if (!onValueChange) throw Error('`onValueChange` is required');
...
type FormMultiSelectProps<Values extends FieldValues> =
  FormChildrenProps<Values> &
    Omit<MultiSelectProps, 'defaultValue' | 'onValueChange'>;

export const FormMultiSelect = <Values extends FieldValues = FieldValues>({
  control,
  containerClassName,
  ...props
}: FormMultiSelectProps<Values>): React.ReactNode => {
  return (
